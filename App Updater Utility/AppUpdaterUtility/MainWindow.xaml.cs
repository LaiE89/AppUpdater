...
namespace AppUpdater
{
	...
	public partial class MainWindow : Window
	{
		...
		{
			// Directory.CreateDirectory("%USERPROFILE%\\AppData\\LocalLow\\Ryze Entertainment\\Dystopia");
			string folder = Directory.GetParent(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData)).ToString();

			// Combine the base folder with your specific folder....
			string specificFolder = Path.Combine(folder, "LocalLow\\Ryze Entertainment\\Dystopia");
